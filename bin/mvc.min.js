...
reset:function(){this._routeMap=[]},add:function(a,b){if(!a.test||typeof a.test!="function")throw"Route "+a+" is not added as a regular expression!";var c={route:a,eventType:b};this._routeMap.push(c);return c},navigate:function(a){this._history.pushState({},null,a)},trigger:function(a){var b=false,c;for(c in this._routeMap){var d=this._routeMap[c];d.route.test(a)&&(b=true,Event.trigger(d.eventType,this._history.getState()))}return b},_onStateChange:function(){this._active&&Router.trigger(this._history.getState().url)}}))})(window);
